...
const sign =
  w =>
  async (jwk, headers, claims, demonstratingProofOfPossessionConfiguration, jwtHeaderType = 'dpop+jwt') => {
...
async function generateDpopAsync(originalRequest, currentDatabase, url, extrasClaims = {}) {
  ...
  if (
    (currentDatabase == null ? void 0 : currentDatabase.demonstratingProofOfPossessionConfiguration) &&
    ...
    (!currentDatabase.demonstratingProofOfPossessionOnlyWhenDpopHeaderPresent ||
      (currentDatabase.demonstratingProofOfPossessionOnlyWhenDpopHeaderPresent && headersExtras['dpop']))
  ) {
...
const handleFetch = async event => {
  ...
  const currentDatabaseForRequestAccessToken = getCurrentDatabaseDomain(database, url, trustedDomains)
  if (
    (_a = currentDatabaseForRequestAccessToken == null ? void 0 : currentDatabaseForRequestAccessToken.tokens) == null
      ? void 0
      : _a.access_token
  ) {
    ...
    const maPromesse = new Promise((resolve, reject) => {
      ...
      const response = clonedRequest.text().then(async actualBody => {
        ...
        if (actualBody.includes(TOKEN.REFRESH_TOKEN) || actualBody.includes(TOKEN.ACCESS_TOKEN)) {
          ...
          if (
            ((_a2 = currentDatabase == null ? void 0 : currentDatabase.oidcServerConfiguration) == null
              ? void 0
